...
<body>     
         ...
         <%-- <asp:Button ID="btnLogout" runat="server" class="btn btn-danger" Text="Cerrar Sesión"   OnClick="btnLogout_Click"  />--%>
                   ...
                   <legend><center><h2><b>Empleado Principal </b></h2></center></legend><br>
              <fieldset>
       ...
       <div class="form-group" style="font-family: 'Century Gothic'; " align="left">
       <asp:Label runat="server" Text="Estado civil:" CssClass="control-label col-sm-2" for="sexo" Font-Bold="True"></asp:Label>   
       <asp:DropDownList ID="ddlEstadoCivil" CssClass="form-control form-select border border-secondary " runat="server" Width="209px" >  </asp:DropDownList> 
</div>
 ...
 <%-- Detalle--%>
       ...
       <div  class="table-responsive">
        ...
        Select="new (strNombre,strRFC, dteFechaNacimiento, strAPaterno, strAMaterno, CatSexo, CatEstadoCivil, strClaveUnica,id)" 
